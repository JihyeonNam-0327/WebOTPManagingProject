...
<%!
	//연도, 달 이동 헬퍼 메소드
	private String traverseDate(String type, int year, int month, String id, String name){
		String href = "";
		if(type.equals("upYear")){
			href = "./manageMonthDetail.jsp?year=" + (year+1) + "&month=" + month + "&id=" + id + "&name=" + name;
		}else if(type.equals("downYear")){
			href = "./manageMonthDetail.jsp?year=" + (year-1) + "&month=" + month + "&id=" + id + "&name=" + name;
		}else if(type.equals("upMonth")){
			if(month == 11){
				href = "./manageMonthDetail.jsp?year=" + (year+1) + "&month=0" + "&id=" + id + "&name=" + name;
			}else{
				href = "./manageMonthDetail.jsp?year=" + year + "&month=" + (month+1) + "&id=" + id + "&name=" + name;
			}
		}else if(type.equals("downMonth")){
			if(month == 0){
				href = "./manageMonthDetail.jsp?year=" + (year-1) + "&month=11" + "&id=" + id + "&name=" + name;
			}else{
				href = "./manageMonthDetail.jsp?year=" + year + "&month=" + (month-1) + "&id=" + id + "&name=" + name;
			}
		}
...
try{
	...
	out.println("	<tr>");
	out.println("		<td colspan="+row+" align=center><a href='"+traverseDate("downYear", year, month,id,name)+"'>");
	out.println("		<font style='text-decoration: none;'>〈 &nbsp;</font></a><font style='font-size: 18'>"+year+"</font>");
	out.println("		<a href='"+traverseDate("upYear", year, month,id,name)+"'><font style='text-decoration: none;'> &nbsp;〉</font></a>&nbsp;");
	out.println("		<a href='"+traverseDate("downMonth", year, month,id,name)+"'><font style='text-decoration: none;'>〈&nbsp; </font></a>");
	out.println("		<font style='font-size: 18'>"+(month+1)+"</font><a href='"+traverseDate("upMonth", year, month,id,name)+"'>");
